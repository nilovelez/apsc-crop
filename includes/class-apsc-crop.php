...
class APS_C_Crop {
    ...
    public function init() {
        add_shortcode('crop_factor_calculator', array($this, 'render_calculator'));
    ...
    public function render_calculator() {
        ...
        wp_enqueue_style('apsc-crop');
        wp_enqueue_script('apsc-crop');
        ...
        ob_start();
        ?>
        <div class="apsc-calculator">
            <div class="apsc-form">
                <div class="apsc-field">
                    <label for="focal_length"><?php esc_html_e('Focal Length (mm):', 'apsc-crop'); ?></label>
                    <input type="number" id="focal_length" name="focal_length" min="1" step="0.1" required>
                </div>
                
                <div class="apsc-field">
                    <label for="aperture"><?php esc_html_e('Aperture (f/):', 'apsc-crop'); ?></label>
                    <input type="number" id="aperture" name="aperture" min="0.7" step="0.1" required>
                </div>

                <div class="apsc-field">
                    <label for="crop_factor"><?php esc_html_e('Crop Factor:', 'apsc-crop'); ?></label>
                    <select id="crop_factor" name="crop_factor" required>
                ...
                <div class="apsc-results" style="display: none;">
                    <h3><?php esc_html_e('Equivalent Values', 'apsc-crop'); ?></h3>
                    <div class="apsc-result-field">
                        <span class="apsc-label"><?php esc_html_e('Equivalent Focal Length:', 'apsc-crop'); ?></span>
                        <span id="equivalent_focal_length" class="apsc-value"></span>
                    </div>
                    <div class="apsc-result-field">
                        <span class="apsc-label"><?php esc_html_e('Equivalent Aperture:', 'apsc-crop'); ?></span>
                        <span id="equivalent_aperture" class="apsc-value"></span>
                    </div>
                </div>

                <div class="apsc-explanation">
